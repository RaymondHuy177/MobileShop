...
namespace AssignmentEC.Models
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "raymondhuy177-facilitator_api1.gmail.com";
        private string APIPassword = "DAECVY2K42U7Y7VY";
        private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A6HCR38XM5kYYKAyUgZy5RMLGqw6";
    ...
    public sealed class NVPCodec : NameValueCollection
    {
        ...
        private static string GetArrayName(int index, string name)
        {
            if (index < 0)
            {
                throw new System.ArgumentOutOfRangeException("index", "index cannot be negative : " + index);
            }
            return name + index;
        }
    }
