<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailProduct.aspx.cs" Inherits="AssignmentEC.DetailProduct" %>
...
<head runat="server">
    <title id="nameTitle" runat="server">Information</title>
    ...
    <script src="Detail/js/jquery_and_jqueryui.js"></script>


    <!--<script type="text/javascript" src="js/jquery-1.9.0.min.js"></script>-->
    <script src="Detail/js/jquery.openCarousel.js" type="text/javascript"></script>
    <script type="text/javascript" src="Detail/js/easing.js"></script>
    <script type="text/javascript" src="Detail/js/move-top.js"></script>
    <script src="Detail/js/easyResponsiveTabs.js" type="text/javascript"></script>
    <link href="Detail/css/easy-responsive-tabs.css" rel="stylesheet" type="text/css" media="all" />
        ...
        $(document).ready(function () {
            ...
            $('#etalage').etalage({
                ...
                click_callback: function (image_anchor, instance_id) {
                    ;
                }//anh xu ly lenh nay di
            });
        });
    </script>
    <link rel="stylesheet" href="Detail/css/etalage.css">
    <script src="Detail/js/jquery.etalage.min.js"></script>
    <script src="Detail/js/star-rating.js" type="text/javascript"></script>
...
<body style="background: url(../images/bg.png) repeat center center; margin: 0 auto;">
    ...
    <form id="form1" runat="server">
                                ...
                                <div class="cont-desc span_1_of_2">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="desc span_3_of_2">
                                            <h1 id="namePhone" runat="server">Whirlpool LTE5243D 3.4 CuFt.... </h1>
                                            <p>Warranty at all warranty centers</p>
                                            <div class="price">
                                                <strong>
                                                    <p id="pricePhone" runat="server">Price: <span>$839.93</span></p>
                                                </strong>
                                            </div>
                                            <div class="available">
                                                <ul>
        ...
        <a href="#" id="toTop"></a>
        <script type="text/javascript" src="Detail/js/navigation.js"></script>
